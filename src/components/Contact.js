    ...
    <section className="w-full bg-gray py-16 md:py-20 2xl:py-24" id="contact">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 md:gap-12 md:px-8">
        ...
        <div className="flex flex-col items-center gap-6 md:gap-12">
          <div className="flex flex-col items-center md:gap-4 sm:gap-2 ">
            <div className="flex items-center gap-2 md:gap-5">
              <div className="[&_svg]:w-5 [&_svg]:h-5 md:[&_svg]:h-8 md:[&_svg]:w-8">
                <svg
              ...
              <button
                className="relative flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 rounded-lg p-1.5 transition-colors duration-200 [&_svg]:stroke-gray-600 [&_svg]:hover:stroke-gray-700 [&_svg]:w-5 [&_svg]:h-5 md:[&_svg]:h-8 md:[&_svg]:w-8"
