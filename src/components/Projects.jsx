        ...
        <div className="rounded-xl bg-gray shadow-md dark:bg-gray-100 dark:shadow-2xl mx-auto flex w-full max-w-6xl flex-col md:flex-row">
          <div className="flex items-center justify-center border-gray-100 bg-gray-50 p-8 dark:bg-gray-200 max-md:rounded-t-xl md:w-1/2 lg:p-12 md:rounded-l-xl md:border-r md:order-last">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://linkbreeze.netlify.app/"
            >
              <img
                alt="Shopping App"
                loading="lazy"
                ...
                className="rounded-xl shadow-lg transition-transform duration-500 md:hover:scale-105"
                style={{ color: "transparent", objectFit: "cover" }}
                src="https://res.cloudinary.com/dgsjppp4a/image/upload/v1739583370/mbjdyotqrcb9wq502ely.png"
              ></img>
            </a>
          </div>
          <div className="flex flex-col gap-6 p-8 md:w-1/2 lg:p-12 md:order-first">
            ...
            <p className="text-normal text-base">
              Experience effortless link management with Link Breeze! ✨ Shorten
              URLs instantly, track analytics seamlessly, and optimize your
              online presence—all in one place. Whether you're a marketer,
              content creator, or just love simplicity, Link Breeze makes link
              sharing smarter and more efficient. Try it now and take control of
              your links!
            </p>
            <div className="flex flex-wrap gap-2">
              <div className="flex items-center justify-center rounded-xl bg-gray-200 px-5 py-1">
